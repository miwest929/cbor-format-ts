...
class CBOR {
    ...
    static consumeSmallArray(bytes, idx) {
    ...
    static consumeTinyUnsignedInteger(bytes, idx) {
        return { nextIndex: idx + 1, decodedItem: bytes[idx] };
    }
    static consumeTinyUtf8String(bytes, idx) {
        // utf8 string
    ...
    static consumeMapObject(bytes, idx) {
